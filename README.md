...
- `$skill-installer install https://github.com/mzbac/skills/tree/main/skills/design-cli`
...
- `python3 ~/.codex/skills/.system/skill-installer/scripts/install-skill-from-github.py --repo mzbac/skills --path skills/code-review-low skills/diagram-first skills/design-cli skills/planning-with-files skills/ask-questions-if-underspecified`
